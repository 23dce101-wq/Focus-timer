...
import { Info, Target, Users, Zap, Award } from 'lucide-react';
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <div className="mb-8 flex items-center gap-4">
            ...
            <h1 className="text-4xl font-display font-bold">About TimerFlow</h1>
          </div>
          ...
          <div className="space-y-12">
            ...
            <section className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-xl border">
