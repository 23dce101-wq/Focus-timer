...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Your theme preference is saved locally in your browser using localStorage. We don\'t collect or store any personal data or timer usage information on external servers.',
  },
];
